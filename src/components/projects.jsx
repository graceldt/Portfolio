...
function Projects (){
    return (
        <div>
            ...
            <Card title="Kasa" image={Kasa} tags={['HTML','CSS', 'REACT']} description="Création d'une application web de location immobilière avec React"/>
            ...
            <Card title="Argent Bank" image={ArgentBank} tags={['HTML','CSS', 'REACT']} description="Implémentation du front-end d'une application bancaire avec React"/>
